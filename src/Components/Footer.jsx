            ...
            <div className="footer-desktop">
              ...
              <ul className="space-y-1 md:space-y-2">
                ...
                <li>
                  ...
                  <li>
                  <Link to="/exhibitions" className="text-gray-400 hover:text-primary transition-colors duration-300 text-xs md:text-sm block py-0.5 md:py-1">
                    Exhibitions
                  </Link>
            ...
            <div className="footer-mobile">
              ...
              <div className={`dropdown-content ${openDropdowns.quickLinks ? 'open' : 'closed'}`}>
                <ul className="space-y-2 mb-4">
                  ...
                  <li>
                    <Link to="/exhibitions" className="text-gray-400 hover:text-primary transition-colors duration-300 text-sm block py-1">
                      Exhibitions
                    </Link>
                  </li>
                </ul>
          ...
          <div className="footer-desktop">
            ...
            <ul className="space-y-1 md:space-y-2">
              {Object.keys(categories).map((categoryName, index) => (
                <li key={index}>
                  <a
                    className="text-gray-400 hover:text-primary transition-colors duration-300 text-xs md:text-sm block py-0.5 md:py-1"
